...
<p align="center">
  <b>추지호 | Backend 중심 Full Stack Developer</b><br/>
...
## 📌 About Me
- 💻 Backend 중심의 Full Stack 개발자  
- ⚙️ 시스템 안정성 및 성능 최적화 경험  
- 🔁 장애 원인 분석(RCA) 기반 재발 방지 개발  
- 🎨 AJAX / jQuery 기반 비동기 처리 및 UI 구현 가능  
...
![Bootstrap](https://img.shields.io/badge/Bootstrap4-7952B3?style=for-the-badge&logo=bootstrap&logoColor=white)
...
- JDK: Amazon Corretto 11, OpenJDK 15  
...
## 🎯 Goal
> 안정성과 확장성을 고려한 시스템을 구축하며,  
> 사용자와 운영자 모두에게 효율적인 서비스를 제공하는 개발자가 되고자 합니다.
